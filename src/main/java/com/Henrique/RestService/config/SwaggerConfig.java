package com.Henrique.RestService.config;
...
public class SwaggerConfig {
	...
	private Info apiInfo() {
		return new Info().title("Backend Spring - API").description("API").version("v1")
				.license(new License().name("Apache 2.0").url("http://springdoc.org"))
				.contact(new Contact().name("Henrique araujo").url("https://github.com/Henrique-Arau")
						.email("penielh43@gmail.com"));
	}
